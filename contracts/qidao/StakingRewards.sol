...
import "@openzeppelin/contracts_latest/utils/structs/EnumerableSet.sol";
...
contract Farm is Ownable, ReentrancyGuard {
    ...
    constructor(IERC20 _erc20, uint256 _rewardPerBlock, uint256 _startBlock, address _feeAddress) {
        erc20 = _erc20;
