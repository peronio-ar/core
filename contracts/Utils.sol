 ...
 *
 * @dev Credit to Remco Bloemen under MIT license https://2%CF%80.com/21/muldiv/index.html
 */
function mulDiv(
    uint256 a,
    uint256 b,
    ...
    unchecked {
        ...
        // Now that denominator is an odd number, it has an inverse modulo 2**256 such that denominator * inv = 1 mod 2**256
        // Compute the inverse by starting with a seed that is correct correct for four bits. That is, denominator * inv = 1 mod 2**4
